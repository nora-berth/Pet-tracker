...
class TestPetListAPI:
    ...
    def test_get_pet_list_with_data(self, authenticated_client):
        ...
        Pet.objects.create(name="Whiskers", species="cat", owner=authenticated_client.user)
...
class TestPetDetailAPI:
    ...
    def test_get_pet_detail_includes_nested_records(self, authenticated_client):
        # Arrange
        pet = Pet.objects.create(name="Buddy", species="dog", owner=authenticated_client.user)
...
class TestPetDeleteAPI:
    ...
    def test_delete_pet_cascades_to_related_records(self, authenticated_client):
        # Arrange
        pet = Pet.objects.create(name="TestPet", species="dog", owner=authenticated_client.user)
...
class TestAuthenticationAndAuthorization:
    ...
    def test_authenticated_user_can_list_own_pets(self, authenticated_client):
        # Arrange
        Pet.objects.create(name='MyPet1', species='dog', owner=authenticated_client.user)
        Pet.objects.create(name='MyPet2', species='cat', owner=authenticated_client.user)
    ...
    def test_user_cannot_access_other_users_pet_detail(self, authenticated_client, second_user):
        # Arrange
        other_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
    ...
    def test_user_cannot_update_other_users_pet(self, authenticated_client, second_user):
        # Arrange
        other_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
    ...
    def test_user_cannot_delete_other_users_pet(self, authenticated_client, second_user):
        # Arrange
        other_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
...
class TestMultiTenancyWeightRecords:
    ...
    def test_user_can_only_see_weight_records_for_own_pets(self, authenticated_client, second_user):
        # Arrange
        my_pet = Pet.objects.create(name='MyPet', species='dog', owner=authenticated_client.user)
        their_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)

        WeightRecord.objects.create(pet=my_pet, date=date.today(), weight=Decimal('20.0'), unit='kg')
        WeightRecord.objects.create(pet=their_pet, date=date.today(), weight=Decimal('5.0'), unit='kg')
    ...
    def test_user_cannot_access_weight_record_for_other_users_pet(self, authenticated_client, second_user):
        # Arrange
        their_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
...
class TestMultiTenancyVaccinations:
    ...
    def test_user_can_only_see_vaccinations_for_own_pets(self, authenticated_client, second_user):
        # Arrange
        my_pet = Pet.objects.create(name='MyPet', species='dog', owner=authenticated_client.user)
        their_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
    ...
    def test_user_cannot_access_vaccination_for_other_users_pet(self, authenticated_client, second_user):
        # Arrange
        their_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
...
class TestMultiTenancyVetVisits:
    ...
    def test_user_can_only_see_vet_visits_for_own_pets(self, authenticated_client, second_user):
        # Arrange
        my_pet = Pet.objects.create(name='MyPet', species='dog', owner=authenticated_client.user)
        their_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
    ...
    def test_user_cannot_access_vet_visit_for_other_users_pet(self, authenticated_client, second_user):
        # Arrange
        their_pet = Pet.objects.create(name='TheirPet', species='cat', owner=second_user)
